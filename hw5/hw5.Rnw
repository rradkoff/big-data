...
\Vref{fig:fig1,fig:fig2,r:test-c,r:test-c2}
...
\section{Appendix}
<<test-c, ref.label='test-c', rlabel=TRUE, eval=FALSE, echo=TRUE>>=
@
<<test-c2, ref.label='test-c', rlabel=TRUE, eval=FALSE, echo=TRUE>>=
@
